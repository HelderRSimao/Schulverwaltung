...
using Schulverwaltung.Extensions;

namespace Schulverwaltung.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class CategoryItemController : Controller
    {
        ...
        {
            List<CategoryItem> list = await (from catItem in _context.CategoryItem  //lECTURE/DISCIPLINAS RELACIONADAS PARA O  CURSO QUE O UTILIAXDOR CLICKOU e criou 
        ...
        public async Task<IActionResult> Create(int categoryId)
        {
            ...
            {
                CategoryId = categoryId,
                MediaTypes = mediaTypes.ConvertToSelectList(0)//Categorey item media ou video para a dropwdon
            };
            return View(categoryItem);
        }
