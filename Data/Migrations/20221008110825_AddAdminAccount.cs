...
namespace Schulverwaltung.Data.Migrations
{
    ...
    {
        const string ADMIN_USER_GUID = "8a339ae3-1e2a-427a-a063-b3d7d6ff3221";
        const string ADMIN_ROLE_GUID = "8b8c92e0-1f7c-4d65-a422-3a5516c4541e";
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            sb.AppendLine(",'admin@schule.com'");
            sb.AppendLine(",'ADMIN@SCHULE.COM'");
            sb.AppendLine(",'admin@schule.com'");
            sb.AppendLine(", 0");
            sb.AppendLine(", 0");
